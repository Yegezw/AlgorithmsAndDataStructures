...
import week12.rbTree.RBTree;
import week8.map.BSTMap;
import week8.set.TestBSTSet;

//import practice.other.HashTable;
...
public class TestHashTable {
    ...
    static {
        file = Objects.requireNonNull(TestBSTSet.class.getClassLoader().getResource("pride-and-prejudice.txt")).getPath();
